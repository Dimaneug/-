...
class MyDataBase:
    ...
    # Функция для формирования запроса INSERT
    ...
    # Функция для формирования запроса UPDATE
    ...
    # Функция для формирования запроса DELETE
    ...
    def show_table_window(self):
        ...
        # Проверяем, есть ли введённая таблица в бд
        self.cursor = self.conn.cursor()
        for row in self.cursor.tables():
            if row.table_name == self.table_name:
                break
        else:
            self.show_warning('Такой таблицы нет в базе данных!')
            return
    ...
    # Возврат в main_window из table_window
    ...
    # Вывод окна с INSERT запросом
    def show_insert_window(self):
        self.hide_table()
        self.insert_window()

    # Возврат из insert_window в table_window
    ...
    # Подтверждение запроса INSERT
    def submit_insert(self):
        self.insert_operation()
        self.back_from_insert()

    # Вывод окна с UPDATE запросом
    ...
    # Возврат из update_window в table_window
    ...
    # Подтверждение запроса UPDATE
    def submit_update(self):
        self.update_operation()
        self.back_from_update()

    # Вывод окна с DELETE запросом
    ...
    # Возврат из delete_window в table_window
    ...
    # Главное окно с выбором таблицы
    ...
    # Окно с таблицей и 4 кнопками
    def table_window(self):
        query = "SELECT * FROM " + self.table_name
        self.run_query(query)
        # Избегаем ошибки в table_window, возвращаясь в main_window
    ...
    # Окно для формирования INSERT запроса
    ...
    # Окно для формирования UPDATE запроса
    ...
    # Окно для формирования DELETE запроса
    ...
    # Функция для выполнения запросов. Может принимать параметры отдельно
    ...
    @staticmethod
    def show_error(where, error):
        showerror(title="Ошибка в " + where, message=error)

    @staticmethod
    def show_warning(mes):
        showwarning(title="Внимание", message=mes)
